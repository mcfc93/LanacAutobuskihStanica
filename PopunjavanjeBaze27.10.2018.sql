...
#LINIJA
INSERT INTO `bus`.`linija` (`IdLinije`,`NazivLinije`,`IdStanice`) VALUES ('11','Banja Luka - Prijedor',10);
INSERT INTO `bus`.`linija` (`IdLinije`,`NazivLinije`,`IdStanice`) VALUES ('12','Banja Luka - Gradiska',10);
INSERT INTO `bus`.`linija` (`IdLinije`,`NazivLinije`,`IdStanice`) VALUES ('13','Gradiska - Prijedor',11);
...
INSERT INTO `bus`.`rezervacija` (`IdRezervacije`, `DatumRezervacije`, `BrojKarata`, `ImePrezimePutnika`, `KontaktOsoba`, `IdStanice`) VALUES ('0002', '2018-09-20', '4', 'Bojan Bojanic', 'Petar', '10');
INSERT INTO `bus`.`rezervacija` (`IdRezervacije`, `DatumRezervacije`, `BrojKarata`, `ImePrezimePutnika`, `KontaktOsoba`, `IdStanice`) VALUES ('0003', '2018-10-01', '20', 'Goran Zabic', 'Milena', '11');
...
#KARTA
INSERT INTO `bus`.`karta` (`IdKarte`, `IdStanice`, `JMBG`, `IdRelacije`, `IdRezervacije`) VALUES ('1', '10', '1506988196387', '401', '0001');
INSERT INTO `bus`.`karta` (`IdKarte`, `IdStanice`, `JMBG`, `IdRelacije`, `IdRezervacije`) VALUES ('2', '11', '2509994362654', '403', '0002');
INSERT INTO `bus`.`karta` (`IdKarte`, `IdStanice`, `JMBG`, `IdRelacije`) VALUES ('3', '10', '2509994362654', '402');
